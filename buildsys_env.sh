...
if [ "$BUILD_SYS_ENV" == "" ]; then
	...
	$BUILD_SYS_PATH/shell/bin/print_color.sh -y "[Set buildsys path]:"
	$BUILD_SYS_PATH/shell/bin/print_color.sh -g "BUILD_SYS_PATH = $BUILD_SYS_PATH"
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	$BUILD_SYS_PATH/shell/bin/print_color.sh -y "config env is done."
fi
